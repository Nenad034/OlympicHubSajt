  ...
  return (
    <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/70 via-purple-900/60 to-blue-900/70 backdrop-blur-[2px]" />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-20 text-center z-10">
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <p className="text-sm text-white/80 mb-4">Popular destinations right now:</p>
          <div className="flex flex-wrap gap-3 justify-center">
